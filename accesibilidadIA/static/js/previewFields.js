/*     document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const startButton = document.getElementById('submitBtn'); // Botón de "Iniciar análisis"
    
        // Actualizar datos de la vista previa cuando la sección es visible
        if ('IntersectionObserver' in window) {
            const previewSection = document.querySelector('.analysis-preview-container');
        ...
        // Iniciar análisis solo al hacer clic en el botón
        startButton.addEventListener('click', (event) => {
            console.log("entro pa ca");
